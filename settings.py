...
SESSION_CONFIGS = [
    ...
    dict(
        name='resource_reproduction_9',
        display_name='Resource_Reproduction_9',
        num_demo_participants=2,
        players_per_group=2,
        app_sequence=['resource_reproduction_9'],
        num_rounds=20,
        pool_start=10,
    )
]
...
SECRET_KEY = 'y$hm(yu%pv&9y6)q1h-5sh(rsr$ar-25=xtnjo8riguqjlz2(3'
